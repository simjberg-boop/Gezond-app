...
// functions-src/send-reminders.mjs
var import_web_push = __toESM(require_src2(), 1);
var VAPID_PUBLIC = "BNn4Ey489gcmrUNHgyc4goW4eymOnX112e0ecpNYtR7QzYTTFwY0iutzg3-gB6YC9jb5wH4dRjfNoU57CZU_eI8";
var send_reminders_default = async () => {
  const priv = process.env.VAPID_PRIVATE_KEY;
  if (!priv)
    return new Response("VAPID_PRIVATE_KEY ontbreekt als omgevingsvariabele", { status: 500 });
  import_web_push.default.setVapidDetails("mailto:gezond-app@goodrecruit.nl", VAPID_PUBLIC, priv);
...
export {
  config,
  send_reminders_default as default
};
