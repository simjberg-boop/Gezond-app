...
// functions-src/subscribe.mjs
var keyFor = (endpoint) => Buffer.from(endpoint).toString("base64url").slice(-48);
var subscribe_default = async (req) => {
